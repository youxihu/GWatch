...
func (uc *MonitoringUseCase) PrintMetrics(m *entity.SystemMetrics) {
	...
	// 打印HTTP接口监控信息
	if m.HTTP.Error != nil {
		log.Println("HTTP接口监控失败:", m.HTTP.Error.Error())
	} else {
